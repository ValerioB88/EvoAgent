...
evo_canvas = SimpleCanvas(*size, name_run, f'pop_loaded: ./data/{pop_loaded}/save_pop/step1000.pickle')

epochs = deque([Epoch(10000, [0.8]*200)])

model_params = {
    # "pop": f"./data/{pop_loaded}/save_pop/step1000.pickle",  # test a population with a new model.
    "pop_path": pickle.load(open("./data/difficult_envS0/save_pop/step1000.pickle", 'rb')),  # you can also pass the list of agents directly
